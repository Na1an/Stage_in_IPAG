...
# Calculate the stdev of the annulus where the companion is located.
def get_stdev(data):
    '''
    Args:
        data : a np.array, 2 dimensions. A image.
    Rrturn:
        np.std(pixels) : a float. Return the stdev of the annulus where the companion is located.
    ''' 
